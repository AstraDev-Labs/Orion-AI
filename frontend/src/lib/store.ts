...
const CONVERSATIONS_KEY = 'orion-conversations';
const SETTINGS_KEY = 'orion-settings';
const OPTIN_KEY = 'orion-optin';
const OPTIN_NAME_KEY = 'orion-display-name';
const OPTIN_EMAIL_KEY = 'orion-email';
const OPTIN_ANONID_KEY = 'orion-anon-id';
const OPTIN_SEEN_KEY = 'orion-optin-seen';
