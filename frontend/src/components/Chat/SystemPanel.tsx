...
export function SystemPanel() {
  ...
  return (
    <div
      className="flex flex-col h-full overflow-y-auto relative z-10"
      style={{
        width: 280,
        minWidth: 280,
    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-mono tracking-widest text-purple-400 font-bold uppercase" style={{ textShadow: '0 0 6px rgba(168, 85, 247, 0.4)' }}>
            [ORION_SYS_01]
          </span>
        </div>
        <button
          onClick={toggleSystemPanel}
          className="p-1 rounded-md transition-colors cursor-pointer text-zinc-500 hover:text-purple-300"
          title="Close panel"
        >
          <X size={14} />
        </button>
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <section>
          ...
          <a
            href="https://open-orion.github.io/Orion/leaderboard"
            target="_blank"
...
function MiniStat({
  ...
  return (
    <div
      className="rounded-lg px-2.5 py-2 border relative overflow-hidden transition-all duration-200 hover:border-purple-400/30"
      style={{ 
        background: 'rgba(255, 255, 255, 0.02)', 
        borderColor: 'rgba(168, 85, 247, 0.1)' 
      }}
    >
      <div className="absolute top-0 left-0 w-1.5 h-[1px] bg-purple-400/40" />
      ...
      <div className="text-sm font-semibold font-mono text-purple-100" style={{ textShadow: '0 0 6px rgba(168,85,247,0.2)' }}>
        {value}
        {unit && (
          <span className="text-[10px] font-normal ml-0.5 text-zinc-500">
            {unit}
          </span>
        )}
      </div>
