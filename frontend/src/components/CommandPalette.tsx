...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'orion-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'orion-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to Orion servers</span>
          )}
        </div>
      </div>
    </div>
