...
const OPTIN_KEY = 'orion-desktop-optin';
const OPTIN_NAME_KEY = 'orion-desktop-display-name';
const OPTIN_EMAIL_KEY = 'orion-desktop-email';
const OPTIN_ANONID_KEY = 'orion-desktop-anon-id';
