...
// Use ANGLE D3D11 backend - most stable on Windows while keeping WebGL working
// This fixes "GPU state invalid" and flickering on desktop GPUs
app.commandLine.appendSwitch('use-angle', 'd3d11');
app.commandLine.appendSwitch('ignore-gpu-blocklist');
app.commandLine.appendSwitch('disable-http-cache'); // Helps during development
