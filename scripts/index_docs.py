#!/usr/bin/env python3
"""Index Orion docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Orion docs the boilerplate that
    # crowds retrieval ("Orion runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does orion support?",
