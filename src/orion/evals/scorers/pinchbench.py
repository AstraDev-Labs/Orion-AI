...
Provides transcript translation (Orion events → PinchBench format),
...
from orion.evals.core.event_recorder import EventType
from orion.evals.core.scorer import LLMJudgeScorer
from orion.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Orion name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from OrionAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
