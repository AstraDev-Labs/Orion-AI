...
Single source of truth for every event name and property the Orion
...
see :mod:`orion.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`orion init` finished and config.toml was written.",
        properties={
