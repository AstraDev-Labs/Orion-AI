...
The internal bus (:mod:`orion.core.events`) carries dozens of
...
from orion.analytics.redaction import hash_id
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from orion.analytics.events import KNOWN_TOOL_NAMES
