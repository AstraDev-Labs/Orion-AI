...
def create_energy_monitor(
    ...
    try:
        from orion.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from orion.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from orion.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from orion.telemetry.energy_rapl import RaplEnergyMonitor
