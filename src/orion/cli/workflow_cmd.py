"""``orion workflow`` — workflow management commands."""
...
def list_workflows() -> None:
    ...
    try:
        from orion.workflow.loader import discover_workflows
...
def run(workflow_name: str, input_text: str | None) -> None:
    ...
    try:
        ...
        # Full execution would need a OrionSystem — just report for now
        console.print(
