"""``orion chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from orion.engine import get_engine
    from orion.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import orion.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]Orion Chat[/green bold]\n"
    ...
    from orion.cli._chat_notifications import NotificationDispatcher
