"""LLM-based optimizer for Orion configuration tuning.

Uses a cloud LLM to propose optimal Orion configs, inspired by DSPy's
...
from orion.learning.optimize.types import (
    BenchmarkScore,
    SampleScore,
    SearchSpace,
    TrialConfig,
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Orion configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Orion AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Orion evaluation result.")
        lines.append("")
