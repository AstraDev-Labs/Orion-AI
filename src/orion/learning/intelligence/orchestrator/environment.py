...
Adapted from IPW's ``environment.py``.  Uses Orion's
:class:`~orion.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Orion ``ToolExecutor``.
