...
``~/.orion/learning/skills/<skill-name>/optimized.toml``.
...
from orion.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from orion.core.config import DSPyOptimizerConfig
        from orion.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from orion.learning.agents.gepa_optimizer import GEPAAgentOptimizer
