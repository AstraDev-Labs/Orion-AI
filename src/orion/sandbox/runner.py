...
_OUTPUT_START = "---OPENORION_OUTPUT_START---"
_OUTPUT_END = "---OPENORION_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``orion-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "orion-sandbox:latest"
    DEFAULT_TIMEOUT = 300
