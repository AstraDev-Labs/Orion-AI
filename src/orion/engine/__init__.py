...
import orion.engine.nvidia  # noqa: F401

# Import engine modules to trigger @EngineRegistry.register() decorators
import orion.engine.ollama  # noqa: F401
import orion.engine.openai_compat_engines  # noqa: F401
from orion.engine._base import (
    EngineConnectionError,
    InferenceEngine,
    messages_to_dicts,
)
from orion.engine._discovery import discover_engines, discover_models, get_engine
