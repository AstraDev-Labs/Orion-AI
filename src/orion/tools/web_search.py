...
from orion.security.ssrf import check_ssrf
...
class WebSearchTool(BaseTool):
    ...
    def __init__(self, api_key: str | None = None, max_results: int = 2):
    ...
    def _fetch_url(url: str, max_chars: int = 6000) -> str:
        ...
        resp = httpx.get(
            ...
            timeout=30.0,
            headers={
                "User-Agent": "Mozilla/5.0 (compatible; Orion/1.0; +https://github.com/orion)"
            },
        )
