...
_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "notion_search_pages": ("notion", "search", "pages", "find", "look up"),
    "notion_get_page": ("notion", "read", "page", "contents"),
    "notion_create_page": ("notion", "create", "save", "write", "page", "note"),
    "gmail_search_emails": ("gmail", "email", "inbox", "search", "find", "messages"),
    "github_notifications": ("github", "notifications", "alerts", "repositories"),
