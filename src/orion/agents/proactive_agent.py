...
called from your app startup:
    ...
    from orion.agents.proactive_agent import register_cron
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from orion.tools.channel_tools import ChannelSendTool
        from orion.tools.digest_collect import DigestCollectTool
        from orion.tools.proactive_tools import (
            CheckPermissionTool,
    ...
    def _build_system_prompt(self) -> str:
        user_md = _load_md_file(Path.home() / ".orion" / "USER.md")
        memory_md = _load_md_file(Path.home() / ".orion" / "MEMORY.md")
        now = datetime.now()
        context_block = ""
