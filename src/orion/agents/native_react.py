...
Renamed from ``ReActAgent`` to clarify this is Orion's native
...
from orion.agents.prompt_loader import (
...
from orion.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from orion.engine._stubs import InferenceEngine
from orion.tools._stubs import BaseTool, build_tool_descriptions
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $OPENORION_HOME override for the base template (M2+ work).
        prompt_template = (
