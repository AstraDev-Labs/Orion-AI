...
from orion.agents.hybrid._base import LocalCloudAgent, _record_event
from orion.agents.hybrid._prices import (
    NO_TEMP_PREFIXES,
)
from orion.agents.hybrid._prices import (
    cost as _cost_cloud,
...
def _stub_archon_imports() -> None:
    ...
    libraries aren't installed in the Orion venv."""
