...
from orion.agents.hybrid._base import (
    ANTHROPIC_WEB_SEARCH_TOOL,
    WEB_SEARCH_COST_PER_CALL,
    LocalCloudAgent,
)
from orion.agents.hybrid._prices import NO_TEMP_PREFIXES
...
def _prefetch_context(question: str, cloud_endpoint: str, cloud_model: str) -> Dict[str, Any]:
    ...
    try:
        ...
        from orion.agents.hybrid._prices import cost as _cost_usd
        out.update(
            text=text,
            tokens=p + c,
