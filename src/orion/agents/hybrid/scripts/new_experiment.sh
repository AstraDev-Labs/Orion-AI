...
# src/orion/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m orion.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m orion.agents.hybrid.runner --cell ${name}"
