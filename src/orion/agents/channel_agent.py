...
Routes incoming :class:`~orion.channels._stubs.ChannelMessage` objects
...
from orion.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Orion:\norion://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~orion.agents._stubs.BaseAgent`
        subclass).
    max_workers:
