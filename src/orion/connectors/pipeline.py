...
from orion.connectors._stubs import Attachment, Document
from orion.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from orion.connectors.attachment_store import AttachmentStore
