...
if TYPE_CHECKING:
    from orion.evals.core.types import EvalSuiteConfig
    from orion.operators.types import OperatorManifest
    from orion.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("orion-agent" if has_agent else "orion-direct")
