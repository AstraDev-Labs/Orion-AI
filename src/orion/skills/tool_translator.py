"""ToolTranslator — translate external tool names to Orion equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Orion uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Orion name
# ---------------------------------------------------------------------------
