# Pearl reference oracle (Orion Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the Orion `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `Orion/src/orion/mining/_constants.py`.
