...
Thank you for your interest in contributing to Orion AI! This guide covers everything you need to know — from why to contribute, to how to submit your first pull request.

---

## Why Contribute?

Contributing to Orion AI isn't just about code — it's about building the future of on-device AI together. Here's what you get:
...
Look for issues labeled [`good-first-issue`](https://github.com/AstraDev-Labs/Orion-AI/labels/good-first-issue).
...
2. Check if a [GitHub issue](https://github.com/AstraDev-Labs/Orion-AI/issues) already exists for it — if not, [open one](https://github.com/AstraDev-Labs/Orion-AI/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/AstraDev-Labs/Orion-AI/issues/new/choose):
...
- Open a [Discussion](https://github.com/AstraDev-Labs/Orion-AI/discussions) for questions and help
- Check the `docs/` directory in this repository for guides and reference
