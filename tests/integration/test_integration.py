...
from orion.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
from orion.core.types import (
    Conversation,
    Message,
    Role,
    TelemetryRecord,
...
class TestToolExecutorIntegration:
    ...
    def test_calculator_and_think(self):
        _register_tools()
        from orion.tools._stubs import ToolExecutor
        from orion.tools.calculator import CalculatorTool
        from orion.tools.think import ThinkTool
...
class TestHeuristicRewardWithTelemetry:
    ...
    def test_reward_from_telemetry_record(self):
        from orion.learning._stubs import RoutingContext
...
class TestRouterPolicyRegistryDiscovery:
    ...
    def test_both_policies_registered(self):
        from orion.learning import ensure_registered
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from orion.learning._stubs import RoutingContext
        from orion.learning.routing.heuristic_policy import ensure_registered
        from orion.learning.routing.router import HeuristicRouter
...
class TestSDKImport:
    """Verify Orion class is importable from orion."""

    def test_orion_imports(self):
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        with patch("orion.sdk.get_engine", return_value=("mock", engine)):
            j = Orion(config=OrionConfig(), model="test-model")
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from orion.core.config import OrionConfig
        from orion.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from orion.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from orion.bench import ensure_registered
        from orion.bench._stubs import BenchmarkSuite
        from orion.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        from orion.agents._stubs import AgentResult
        from orion.core.config import OrionConfig
        ...
        with patch("orion.sdk.get_engine", return_value=("mock", engine)):
            j = Orion(config=cfg, model="test-model")
