...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from orion.agents.native_openhands import NativeOpenHandsAgent
        from orion.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from orion.mcp.transport import InProcessTransport
        from orion.tools.calculator import CalculatorTool
        from orion.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from orion.mcp.client import MCPClient
        from orion.mcp.protocol import MCPError
        from orion.mcp.server import MCPServer
        from orion.mcp.transport import InProcessTransport
        from orion.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from orion.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
