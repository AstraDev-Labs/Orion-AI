...
from orion.core.types import Conversation, Message, Role, ToolCall, ToolResult
...
class TestBuildMessages:
    ...
    def test_empty_config_default_no_system_message(self, monkeypatch):
        ...
        empty_cfg = OrionConfig()
        empty_cfg.agent.default_system_prompt = ""
        monkeypatch.setattr("orion.agents._stubs.load_config", lambda: empty_cfg)
