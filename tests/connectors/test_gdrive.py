...
def connector(tmp_path: Path):
    ...
    from orion.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("orion.connectors.gdrive._gdrive_api_list_files")
@patch("orion.connectors.gdrive._gdrive_api_export")
