...
def connector(tmp_path: Path):
    ...
    from orion.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "orion.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("orion.connectors.gcalendar._gcal_api_calendars_list")
@patch("orion.connectors.gcalendar._gcal_api_events_list")
