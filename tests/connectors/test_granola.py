...
def connector(tmp_path: Path):
    ...
    from orion.connectors.granola import GranolaConnector  # noqa: PLC0415
...
@patch("orion.connectors.granola._granola_api_list_notes")
@patch("orion.connectors.granola._granola_api_get_note")
...
def test_format_note_content() -> None:
    ...
    from orion.connectors.granola import _format_note_content  # noqa: PLC0415
...
def test_sync_logs_note_count(
    ...
    with caplog.at_level(logging.INFO, logger="orion.connectors.granola"):
        list(connector.sync())
...
def test_end_to_end_ingest_and_search(
    ...
    from orion.agents.research_loop import (  # noqa: PLC0415
        _hit_url,
