...
def connector(tmp_path: Path):
    ...
    from orion.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("orion.connectors.dropbox._dropbox_api_list_folder")
@patch("orion.connectors.dropbox._dropbox_api_download")
