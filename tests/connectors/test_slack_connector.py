...
def connector(tmp_path: Path):
    ...
    from orion.connectors.slack_connector import SlackConnector  # noqa: PLC0415
...
@patch("orion.connectors.slack_connector._slack_api_auth_test")
@patch("orion.connectors.slack_connector._slack_api_conversations_list")
@patch("orion.connectors.slack_connector._slack_api_conversations_history")
@patch("orion.connectors.slack_connector._slack_api_users_list")
...
@patch("orion.connectors.slack_connector._slack_api_with_retry")
def test_conversations_list_requests_all_conversation_types(mock_retry) -> None:
    ...
    """
    from orion.connectors.slack_connector import (  # noqa: PLC0415
...
def test_end_to_end_ingest_and_search(
    ...
    """
    from orion.connectors.hybrid_search import HybridSearch  # noqa: PLC0415
    from orion.connectors.pipeline import IngestionPipeline  # noqa: PLC0415
    from orion.connectors.store import KnowledgeStore  # noqa: PLC0415
    ...
    from orion.agents.research_loop import _hit_url  # noqa: PLC0415
...
def test_sync_logs_per_type_channel_counts(
    ...
    with caplog.at_level("INFO", logger="orion.connectors.slack_connector"):
        list(connector.sync())
