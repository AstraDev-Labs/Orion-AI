...
_LOCAL_CONNECTORS = [
    ("apple_notes", "orion.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "orion.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "orion.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "orion.connectors.outlook", "OutlookConnector"),
    ("slack", "orion.connectors.slack_connector", "SlackConnector"),
    ("notion", "orion.connectors.notion", "NotionConnector"),
    ("granola", "orion.connectors.granola", "GranolaConnector"),
    ("gdrive", "orion.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "orion.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "orion.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "orion.connectors.dropbox", "DropboxConnector"),
]
