...
class TestDetectHardware:
    ...
    @patch("orion.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "orion.core.config._run_cmd",
    ...
    @patch("orion.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "orion.core.config._run_cmd",
        side_effect=[
    ...
    @patch("orion.core.config.platform.system", return_value="Darwin")
    @patch(
        "orion.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("orion.core.config.shutil.which", return_value=None)
    @patch("orion.core.config.platform.system", return_value="Linux")
