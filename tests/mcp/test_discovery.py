...
_PATCH_HTTP = "orion.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "orion.mcp.transport.StdioTransport"
_PATCH_CLIENT = "orion.mcp.client.MCPClient"
_PATCH_PROVIDER = "orion.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "orion.system.builder.logger"
