...
pytest.importorskip("fastapi", reason="orion[server] not installed")

from fastapi import FastAPI  # noqa: E402
from starlette.testclient import TestClient  # noqa: E402

from orion.core.registry import ChannelRegistry  # noqa: E402
...
def webhook_app(mock_bridge, sendblue_channel):
    from orion.server.webhook_routes import create_webhook_router
