...
- TraceStore at ~/.orion/traces.db with some traces
"""
...
def real_trace_store():
    ...
    if not db_path.exists():
        pytest.skip("No traces.db found at ~/.orion/")
...
class TestDiagnosisRunnerLive:
    ...
    def test_diagnosis_produces_output(
        ...
        from orion.learning.spec_search.diagnose.runner import (
            DiagnosisRunner,
        )
...
class TestColdStartLive:
    ...
    def test_orchestrator_cold_start_with_no_feedback(
        ...
        from orion.learning.spec_search.gate.cold_start import (
