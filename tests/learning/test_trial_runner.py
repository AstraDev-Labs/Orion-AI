"""Tests for orion.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from orion.evals.core.types import RunConfig, RunSummary
from orion.learning.optimize.trial_runner import TrialRunner
from orion.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "orion-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "orion-direct"
...
class TestRunTrial:
    ...
    @patch("orion.evals.cli._build_scorer")
    @patch("orion.evals.cli._build_judge_backend")
    @patch("orion.evals.cli._build_dataset")
    @patch("orion.evals.cli._build_backend")
    @patch("orion.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from orion.evals.core.types import EvalResult
