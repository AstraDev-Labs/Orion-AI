"""Tests for orion.optimize.feedback.collector module."""
...
from orion.learning.optimize.feedback.collector import FeedbackCollector
from orion.learning.optimize.feedback.judge import TraceJudge
