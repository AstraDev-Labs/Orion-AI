...
from orion.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("orion.speech.openai_whisper.OpenAI", return_value=mock_client):
        from orion.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("orion.speech.openai_whisper.OpenAI"):
        from orion.speech.openai_whisper import OpenAIWhisperBackend
