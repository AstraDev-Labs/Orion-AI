...
from orion.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("orion.speech.deepgram.DeepgramClient", return_value=mock_client):
        from orion.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("orion.speech.deepgram.DeepgramClient"):
        from orion.speech.deepgram import DeepgramSpeechBackend
