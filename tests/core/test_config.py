...
class TestDefaults:
    def test_orion_config_defaults(self) -> None:
        cfg = OrionConfig()
...
class TestSecurityConfig:
    ...
    def test_security_config_on_orion_config(self) -> None:
        cfg = OrionConfig()
...
class TestChannelConfig:
    ...
    def test_channel_config_on_orion_config(self) -> None:
        cfg = OrionConfig()
...
class TestSandboxConfig:
    def test_defaults(self) -> None:
        ...
        assert sc.image == "orion-sandbox:latest"
    ...
    def test_on_orion_config(self) -> None:
        cfg = OrionConfig()
...
class TestApplyTomlSectionListNormalization:
    def test_apply_toml_section_list_to_str_field(self) -> None:
        ...
        from orion.core.config import ToolsConfig, _apply_toml_section
    ...
    def test_apply_toml_section_list_to_property_setter(self) -> None:
        ...
        from orion.core.config import _apply_toml_section
...
class TestWhatsAppBaileysChannelConfig:
    def test_defaults(self) -> None:
        ...
        assert wc.auth_dir == ""
        assert wc.assistant_name == "Orion"
