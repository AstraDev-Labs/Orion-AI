...
from orion.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import orion.tools as tools_pkg
        from orion.core.registry import ToolRegistry

        sys.modules.pop("orion.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "OPENORION_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "OPENORION_TEST_PASSTHROUGH_67890"
