"""Verify OrionAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestOrionAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        ...
        with patch("orion.system.SystemBuilder") as MockSB:
            ...
            backend = OrionAgentBackend(model="qwen-9b")
