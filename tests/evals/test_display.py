"""Tests for the Rich display helpers in orion.evals.core.display."""
...
from orion.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "Orion" in output or "___" in output
