...
- OrionDirectBackend propagates gpu_metrics flag
...
from orion.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from orion.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from orion.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# OrionDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify OrionDirectBackend sets gpu_metrics on config."""

    @patch("orion.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("orion.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from orion.evals.core.config import expand_suite
