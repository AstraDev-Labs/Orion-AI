...
from orion.evals.core.event_recorder import AgentEvent, EventType
from orion.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from orion.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Orion tool names are mapped to PinchBench-expected names."""
    from orion.evals.scorers.pinchbench import events_to_transcript
