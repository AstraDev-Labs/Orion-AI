...
from orion.evals.cli import BACKENDS, _build_backend
...
class TestBuildBackendDispatch:
    def test_backends_dict_includes_external(self) -> None:
        ...
        assert "orion-agent" in BACKENDS
        assert "orion-direct" in BACKENDS
    ...
    def test_hermes_returns_hermes_backend(self) -> None:
        ...
        with (
            ...
            patch("orion.evals.backends.external.hermes_agent.verify_commit_pin"),
        ):
