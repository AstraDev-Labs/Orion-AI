...
PROVIDERS = [
    ("orion.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("orion.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("orion.evals.datasets.gaia", "GAIADataset"),
    ("orion.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("orion.evals.datasets.taubench", "TauBenchDataset"),
    ("orion.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("orion.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
