...
class TestCostCalculator:
    ...
    def test_estimate_monthly_cost(self) -> None:
        from orion.server.cost_calculator import estimate_monthly_cost
    ...
    def test_estimate_scenario(self) -> None:
        from orion.server.cost_calculator import estimate_scenario
    ...
    def test_estimate_all_scenarios(self) -> None:
        from orion.server.cost_calculator import estimate_all_scenarios
...
class TestSavings:
    ...
    def test_compute_savings_basic(self) -> None:
        from orion.server.savings import compute_savings
    ...
    def test_energy_wh_matches_direct_formula(self) -> None:
        ...
        from orion.server.savings import CLOUD_PRICING, compute_savings
