...
from orion.agents.native_react import REACT_SYSTEM_PROMPT, NativeReActAgent
...
class TestSystemBuilderCapturesFewShot:
    def test_skill_manager_examples_stored_on_system(self, tmp_path):
        ...
        stashes them on the OrionSystem instance for _run_agent to
...
class TestRunAgentForwardsExamples:
    def test_run_agent_passes_examples_to_tool_using_agent(self):
        ...
        # Build a minimal OrionSystem with the captured examples
        system = OrionSystem.__new__(OrionSystem)
        ...
        with patch(
            "orion.core.registry.AgentRegistry.get",
