...
import orion
from orion.cli import cli, main


class TestMainEntryPoint:
    """Tests for the ``orion`` console script entry point."""
    ...
    def test_windows_reconfigures_stdout_to_utf8(self) -> None:
        ...
        with (
            ...
            mock.patch("orion.cli.cli") as cli_mock,
        ):
            main()
...
class TestCLI:
    ...
    def test_version(self) -> None:
        ...
        assert result.exit_code == 0
        assert orion.__version__ in result.output
