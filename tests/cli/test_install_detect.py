...
from orion.cli._install_detect import InstallInfo, detect_install
...
def test_pypi_install_detected(tmp_path, monkeypatch):
    ...
    assert info.upgrade_command == "pip install --upgrade orion"
...
def test_missing_orion_file_falls_back_to_pypi(monkeypatch):
    """orion unimportable / no __file__ — still get a sane default."""
