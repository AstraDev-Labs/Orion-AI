"""Tests for the ``orion skill`` CLI commands."""
...
class TestSkillCmd:
    ...
    def test_skill_list_shows_discovered_skills(self, tmp_path: Path) -> None:
        ...
        with patch(
            "orion.cli.skill_cmd._get_skill_paths",
...
class TestSkillSearchCommand:
    ...
    def test_search_no_sources_configured(self) -> None:
        from orion.core.config import OrionConfig, SkillsConfig

        cfg = OrionConfig()
        cfg.skills = SkillsConfig(sources=[])
        with patch("orion.cli.skill_cmd.load_config", return_value=cfg):
    ...
    def test_search_filters_results(self) -> None:
        ...
        from orion.skills.sources.base import ResolvedSkill
        ...
        with patch("orion.cli.skill_cmd.load_config", return_value=cfg):
            with patch(
                "orion.cli.skill_cmd._get_resolver",
...
class TestSkillDiscoverCommand:
    ...
    def test_discover_dry_run_no_traces(self, tmp_path: Path) -> None:
        ...
        with patch(
            "orion.cli.skill_cmd._get_trace_store",
    ...
    def test_discover_writes_when_not_dry_run(self, tmp_path: Path) -> None:
        ...
        with patch(
            ...
            with patch(
                "orion.cli.skill_cmd._get_discovered_dir",
...
class TestSkillShowOverlayCommand:
    ...
    def test_show_overlay_missing(self, tmp_path: Path) -> None:
        ...
        with patch(
            "orion.cli.skill_cmd._get_overlay_dir",
    ...
    def test_show_overlay_displays_optimized(self, tmp_path: Path) -> None:
        ...
        from orion.skills.overlay import SkillOverlay, write_overlay
