"""Tests for the ``orion registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the orion registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "orion.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"orion.core.registry": None}):
