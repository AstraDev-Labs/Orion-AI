"""Tests for model resolution fallback chain in orion ask."""
...
def _register_agents():
    ...
    The default ``OrionConfig().agent.default_agent`` is ``"simple"``,
    so ``orion ask "..."`` (without ``--agent``) routes through SimpleAgent.
