...
from orion.core.config import AnalyticsConfig
...
def _clean_env(monkeypatch):
    ...
    monkeypatch.delenv("OPENORION_NO_ANALYTICS", raising=False)
...
class TestEnvOptOut:
    ...
    def test_orion_no_analytics_truthy(self, monkeypatch, value):
        monkeypatch.setenv("OPENORION_NO_ANALYTICS", value)
        assert _env_opt_out() is True
