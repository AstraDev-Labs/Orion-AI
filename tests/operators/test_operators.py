...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "orion.agents._stubs.load_config",
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        from orion.system import QueryOrchestrator

        with patch.object(QueryOrchestrator, "_run_agent", patched_run_agent):
            real_system = OrionSystem(
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from orion.core.config import OperatorsConfig
    ...
    def test_config_in_orion_config(self):
        from orion.core.config import OrionConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "orion" / "operators" / "data"
