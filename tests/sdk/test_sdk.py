"""Tests for the Python SDK — Orion class and MemoryHandle."""
...
class TestOrionInit:
    ...
    def test_version_property(self):
        j = Orion(config=OrionConfig())
        assert j.version == orion.__version__
        j.close()

    def test_engine_key_override(self):
        j = Orion(config=OrionConfig(), engine_key="custom")
        assert j._engine_key == "custom"
        j.close()

    def test_model_override(self):
        j = Orion(config=OrionConfig(), model="my-model")
...
class TestOrionAsk:
    ...
    def test_ask_no_engine_raises(self):
        with patch("orion.sdk.get_engine", return_value=None):
            j = Orion(config=OrionConfig())
