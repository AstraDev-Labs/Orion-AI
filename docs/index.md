...
Orion is a research framework for composable, on-device AI systems.
...
=== "Desktop App"
    ...
    The desktop app is a native window for the Orion UI.
    ...
    **Step 2.** Download and open the desktop app:
    ...
    !!! warning "macOS first launch"
        ...
        Run `xattr -cr /Applications/Orion.app` if the app shows as "damaged".
...
=== "CLI"
    ...
    orion ask --agent orchestrator --tools calculator "What is 137 * 42?"
...
Orion is built around five composable layers. Each has a clean interface and can be swapped independently.

1. **Intelligence** — Pick a model, or let Orion pick one for your hardware. Manages the full catalog of local models across providers.
...
-   **OpenAI-Compatible API**
    ...
    `orion serve` starts a FastAPI server with SSE streaming. Drop-in replacement for OpenAI clients.
...
-   **[Getting Started](getting-started/installation.md)**
    ...
    Install Orion, configure your first engine, and run your first query.
...
-   **[API Reference](api-reference/orion/index.md)**
...
Read the [blog post](https://scalingintelligence.stanford.edu/blogs/orion/) for the full research motivation, architecture details, and experimental results.
...
Follow [@OrionAI](https://x.com/OrionAI) on X for updates.
