...
The default path is `~/.orion/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/orion/security/index.md) — complete class and function signatures
