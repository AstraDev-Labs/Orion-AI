...
```python
from orion.intelligence import merge_discovered_models
...
The following names are still importable from `orion.intelligence` via shim modules, but their canonical locations have moved:
