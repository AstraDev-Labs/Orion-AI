---
title: Downloads
description: Download the Orion desktop app, browser app, CLI, or Python SDK
---
...
by Apple. If you see **"Orion is damaged and can't be opened"**, run this in
