...
use orion_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, orion_core::OrionError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, orion_core::OrionError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, orion_core::OrionError>;

    fn list_models(&self) -> Result<Vec<String>, orion_core::OrionError>;
...
mod tests {
    use super::*;
    use orion_core::{Message, ToolCall};
