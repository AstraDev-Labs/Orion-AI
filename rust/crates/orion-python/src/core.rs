...
impl PyMessage {
    pub fn to_core(&self) -> orion_core::Message {
        let role = match self.role.as_str() {
            "system" => orion_core::Role::System,
            "assistant" => orion_core::Role::Assistant,
            "tool" => orion_core::Role::Tool,
            _ => orion_core::Role::User,
        };
        orion_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: orion_core::OrionConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: orion_core::OrionConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<orion_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(orion_core::EventBus::new(true)),
        }
    }
